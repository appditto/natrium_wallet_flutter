...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Καλωσήρθατε στο Kalium. Μόλις λάβετε BTCO, οι συναλλαγές θα εμφανιστούν ως εξής:"),
    ...
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("Λήφθηκαν %1 BTCO"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("Να σταλθούν %1 BTCO?"),
    ...
    "shareKaliumText" : MessageLookupByLibrary.simpleMessage("Δοκιμάστε το Kalium! Το καλύτερο πορτοφόλι για BTCO σε κινητά τηλέφωνα!"),
