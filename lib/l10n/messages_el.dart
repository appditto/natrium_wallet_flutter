...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Καλωσήρθατε στο Kalium. Μόλις λάβετε BAnyano, οι συναλλαγές θα εμφανιστούν ως εξής:"),
    ...
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("Λήφθηκαν %1 BAnyano"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("Να σταλθούν %1 Banyano?"),
    ...
    "shareKaliumText" : MessageLookupByLibrary.simpleMessage("Δοκιμάστε το Kalium! Το καλύτερο πορτοφόλι για BAnyano σε κινητά τηλέφωνα!"),
