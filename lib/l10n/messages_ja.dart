...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("Natriumへようこそ。 NANOを受け取ると、トランザクションは次のように表示されます。"),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("ログアウトすると、このデバイスからシードとすべてのNatrium関連データが削除されます。シードをバックアップしていない場合、資金に再びアクセスすることができなくなります"),
    ...
    "newAccountIntro" : MessageLookupByLibrary.simpleMessage("これは新しいアカウントです。 NANOを受け取ると、トランザクションは次のように表示されます。"),
    ...
    "notificationBody" : MessageLookupByLibrary.simpleMessage("Natriumを開いてこのトランザクションを表示します"),
    "notificationHeaderSupplement" : MessageLookupByLibrary.simpleMessage("タップして開きます"),
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("％1 NANOを着金しました"),
    ...
    "scanInstructions" : MessageLookupByLibrary.simpleMessage("Nano \n アドレスのQRコードをスキャンします"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("％1 NANOを送金する"),
    ...
    "shareNatriumText" : MessageLookupByLibrary.simpleMessage("優秀なNANOモバイルウォレットであるNatriumを使ってみましょう。"),
    ...
    "transferNoFunds" : MessageLookupByLibrary.simpleMessage("このシードにはNANOが含まれていません"),
    "transferQrScanError" : MessageLookupByLibrary.simpleMessage("このQRコードには有効なシードが含まれていません。"),
    "transferQrScanHint" : MessageLookupByLibrary.simpleMessage("Nano \n シードまたは秘密キーをスキャンします"),
    "unlock" : MessageLookupByLibrary.simpleMessage("ロックを解除する"),
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("Natriumのロックを解除するよう認証する"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("ピンを入力してNatriumのロックを解除する"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("Natriumへようこそ。最初に、新しいウォレットを作成するか、既存のウォレットをインポートします。"),
