...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("BTCO Walletを開く際にパスワードを必要としなくなります。"),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("このパスワードはBTCO Walletを開く際に必要となります。"),
    ...
    "requireAPasswordToOpenHeader" : MessageLookupByLibrary.simpleMessage("BTCO Walletを開く際にパスワードを要求しますか?"),
    ...
    "shareNatrium" : MessageLookupByLibrary.simpleMessage("BTCO Walletを共有する"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("このプロセスにより、資金がペーパーウォレットからBTCO Walletウォレットに転送されます。\n \n「％1」ボタンをタップして開始します。"),
