...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("注销将从此设备中删除您的种子代码和所有与Natrium相关的数据。如果您的种子代码没有备份，您将永远无法再次访问您的帐户"),
    ...
    "shareNatriumText" : MessageLookupByLibrary.simpleMessage("来试试Natrium！ NANO在苹果和安卓系统上的钱包！"),
    ...
    "transferNoFunds" : MessageLookupByLibrary.simpleMessage("这个种子代码没有包含任何 NANO"),
    ...
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("以生物特征解锁 Natrium"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("请输入识别码码解锁 Natrium"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("欢迎来到Natrium。下一步，您可以创建新钱包或导入现有钱包"),
