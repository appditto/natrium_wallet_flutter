...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("欢迎来到Infinitum。当您收到或发送BTCO时，交易将如下出现。"),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("注销将从此设备中删除您的种子和所有与Infinitum相关的数据。如果您的种子代码没有备份，您将永远无法再次访问您的帐户"),
    ...
    "notificationBody" : MessageLookupByLibrary.simpleMessage("打开Infinitum查看此交易"),
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("您以后打开Infinitum不再需要密码了。"),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("以后需要这个密码才能打开Infinitum。"),
    ...
    "requireAPasswordToOpenHeader" : MessageLookupByLibrary.simpleMessage("需要密码来打开Infinitum吗？"),
    ...
    "shareNatrium" : MessageLookupByLibrary.simpleMessage("分享Infinitum"),
    "shareNatriumText" : MessageLookupByLibrary.simpleMessage("来试试Infinitum！ 一个卓越的BTCO手机钱包！"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 BTCO 成功传送到您的 Infinitum 钱包。\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("这个过程会将纸钱包的钱币转移到您的 Infinitum 钱包。\n\n请按 \"%1\" 键开始。"),
    ...
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("验证并解锁 Infinitum"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("请输入识别码来解锁 Infinitum"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("欢迎来到Infinitum。下一步，您可以创建新钱包或导入已有钱包。"),
