...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("歡迎來到 Infinitum。當您收到或發送 BTCO 時，交易將顯示如下："),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("本動作會刪除您在本裝置裡頭的種子及所有和 Infinitum 有關的資料。如果您的種子沒有備份，您將永遠無法存取您的帳戶"),
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("您日後啟動 Infinitum 時不用輸入密碼。"),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("以後需要這個密碼方可開啟 Infinitum。"),
    ...
    "requireAPasswordToOpenHeader" : MessageLookupByLibrary.simpleMessage("需要密碼才可開啟 Infinitum 嗎？"),
    ...
    "shareNatrium" : MessageLookupByLibrary.simpleMessage("分享 Infinitum"),
    "shareNatriumText" : MessageLookupByLibrary.simpleMessage("請試試 Infinitum —— 針對行動裝置的 BTCO 錢包！"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 BTCO 順利移轉到您的 Infinitum 錢包。\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("這過程會將紙錢包的資產移轉至您的 Infinitum 錢包。\n\n輕觸 \"%1\" 按鈕開始。"),
    ...
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("經由生物辨識解鎖 Infinitum"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("請輸入識別碼以解鎖 Infinitum"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("歡迎來到 Infinitum。接著您可建立新錢包或匯入現有錢包"),
