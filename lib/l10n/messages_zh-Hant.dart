...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("歡迎來到 BTCO Wallet。當您收到或發送 BTCO 時，交易將顯示如下："),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("本動作會刪除您在本裝置裡頭的種子及所有和 BTCO Wallet 有關的資料。如果您的種子沒有備份，您將永遠無法存取您的帳戶"),
    ...
    "minimumSend" : MessageLookupByLibrary.simpleMessage("最低發送金額是 %1 BTCO"),
    ...
    "newAccountIntro" : MessageLookupByLibrary.simpleMessage("這是您的新帳戶。當您收到 BTCO 時，交易會顯示如下："),
    ...
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("收到 %1 BTCO"),
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("您日後啟動 BTCO Wallet 時不用輸入密碼。"),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("以後需要這個密碼方可開啟 BTCO Wallet。"),
    ...
    "requireAPasswordToOpenHeader" : MessageLookupByLibrary.simpleMessage("需要密碼才可開啟 BTCO Wallet 嗎？"),
    "rootWarning" : MessageLookupByLibrary.simpleMessage("您的裝置似乎已「越獄」或被修改，從而存在安全疑慮。建議您在繼續之前，將裝置還原至初始狀態。"),
    "scanInstructions" : MessageLookupByLibrary.simpleMessage("掃描 BTCO 二維條碼地址"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("發送 %1 BTCO？"),
    ...
    "shareNatrium" : MessageLookupByLibrary.simpleMessage("分享 BTCO Wallet"),
    "shareNatriumText" : MessageLookupByLibrary.simpleMessage("請試試 BTCO Wallet —— 針對行動裝置的 BTCO 錢包！"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 BTCO 順利移轉到您的 BTCO Wallet 錢包。\n"),
    "transferConfirmInfo" : MessageLookupByLibrary.simpleMessage("偵測到一個內有 %1 BTCO 的錢包。\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("這過程會將紙錢包的資產移轉至您的 BTCO Wallet 錢包。\n\n輕觸 \"%1\" 按鈕開始。"),
    ...
    "transferNoFunds" : MessageLookupByLibrary.simpleMessage("這個種子不含任何 BTCO"),
    "transferQrScanError" : MessageLookupByLibrary.simpleMessage("這個二維條碼不含任何有效的種子"),
    "transferQrScanHint" : MessageLookupByLibrary.simpleMessage("掃描 BTCO 種子"),
    "unlock" : MessageLookupByLibrary.simpleMessage("解鎖"),
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("經由生物辨識解鎖 BTCO Wallet"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("請輸入識別碼以解鎖 BTCO Wallet"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("歡迎來到 BTCO Wallet。接著您可建立新錢包或匯入現有錢包"),
