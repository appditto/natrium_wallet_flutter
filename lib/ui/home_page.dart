  ...
  void _registerBus() {
    ...
    RxBus.register<StateBlock>(tag: RX_REP_CHANGED_TAG).listen((stateBlock) {
      if (stateBlock != null) {
        ...
        UIUtil.showSnackbar(KaliumLocalization.of(context).changeRepSucces);
      }
    });
    ...
    RxBus.register<Contact>(tag: RX_CONTACT_ADDED_ALT_TAG).listen((contact) {
      UIUtil.showSnackbar(KaliumLocalization.of(context).contactAdded.replaceAll("%1", contact.name));
    });
    ...
    RxBus.register<ErrorResponse>(tag: RX_SEND_FAILED_TAG).listen((result) {
      ...
      Navigator.of(context).popUntil(ModalRoute.withName('/home'));
      UIUtil.showSnackbar(KaliumLocalization.of(context).sendError);
    });
  }
